...
class RegisterForm(forms.Form):
    ...
    def save(self):
        ...
        return user
    # def createDefaultRecipes(self):
    #     recipe_1 = Recipe(name="Bavarian Hefeweizen", inote="Fruit 4lbs of Fresh Peaches", note="Loved this beer for summer and beginning fall. Rated it an 8 out of 10. Friends want to try a fruit version and suggested peach.", brewer=self.user )
    #     recipe_1.save()

    #     recipe_2 = Recipe(name="Irish Red Ale", inote="", note="", brewer=self.user )
    #     recipe_2.save()

    #     recipe_3 = Recipe(name="Nut Brown Ale", inote="", note="", brewer=self.user )
    #     recipe_3.save()  
