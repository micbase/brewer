...
urlpatterns = patterns('',
    ...
    url(r'^recipeNote/(?P<recipe_id>\d+)$', brewer.views.RecipeNoteView.as_view(), name='recipe_note'),
    url(r'^ingredietNote/(?P<ingredient_id>\d+)$', brewer.views.IngredientNoteView.as_view(), name='ingredient_note'),
    url(r'^procedureNote/(?P<procedure_id>\d+)$', brewer.views.ProcedureNoteView.as_view(), name='procedure_note'),
